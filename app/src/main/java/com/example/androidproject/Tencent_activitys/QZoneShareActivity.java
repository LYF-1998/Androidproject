...
import com.example.androidproject.Tencent_share.ThreadManager;
...
//                }
    ...
    protected void onDestroy() {
        super.onDestroy();
        if (Recommend.mTencent != null) {
            Recommend.mTencent.releaseResource();
        }
    }
        ...
        ThreadManager.getMainHandler().post(new Runnable() {
            ...
            public void run() {
                if (null != Recommend.mTencent) {
                    Recommend.mTencent.shareToQzone(QZoneShareActivity.this, params, qZoneShareListener);
                }
            }
        });
    }
    ...
    private void doPublishToQzone(final Bundle params) {
        ThreadManager.getMainHandler().post(new Runnable() {
            ...
            public void run() {
                if (null != Recommend.mTencent) {
                    Recommend.mTencent.publishToQzone(QZoneShareActivity.this, params, qZoneShareListener);
                }
            }
        });
    }
